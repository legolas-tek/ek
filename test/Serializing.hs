...
tests = test
  [ "serialize" ~: do
   ...
   , "deserialize str" ~: do
      ...
      runParser (deserialize :: Parser Word8 String) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found EOF" (SourcePos "" 1 12))

   , "deserialize int" ~: do
      let serializedInt = B.unpack (serialize (42 :: Int))

      runParser deserialize serializedInt @?= Right (42 :: Int, stringToWord8 "")
      runParser (deserialize :: Parser Word8 Int) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found EOF" (SourcePos "" 1 12))
   ...
   , "deserialize integer" ~: do
      ...
      runParser (deserialize :: Parser Word8 Integer) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found EOF" (SourcePos "" 1 12))
   ...
   , "deserialize float" ~: do
      ...
      runParser (deserialize :: Parser Word8 Double) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found EOF" (SourcePos "" 1 12))
   ...
   , "deserialize VMValue" ~: do
      ...
      isLeft (runParser (deserialize :: Parser Word8 VMValue) (stringToWord8 "failurecase")) @?= True
   ...
   , "deserialize instruction" ~: do
      ...
      isLeft (runParser (deserialize :: Parser Word8 Instruction) (stringToWord8 "failurecase")) @?= True
   ...
   , "deserialize instruction list" ~: do
      ...
      runParser (deserialize :: Parser Word8 Insts) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found 102" (SourcePos "" 1 1))
   ...
   , "deserialize tuple" ~: do
      ...
      runParser (deserialize :: Parser Word8 (String, Instruction)) (stringToWord8 "failurecase") @?= Left (Diagnostic Error "Expected '\0' but found EOF" (SourcePos "" 1 12))

...
tests = test
  ...
  , "string" ~: do
      ...
      runParser parseString "\"string1\"" @?= Right ("string1", "")
      runParser parseString "\"string1\" " @?= Right ("string1", " ")
      runParser parseString "\"string\0\"" @?= Right ("string\0", "")
      runParser parseString "\"string1\"\0" @?= Right ("string1", "\0")
      runParser parseString "\"string1\\\"\"" @?= Right ("string1\"", "")
      runParser parseString "\"string1\"\"" @?= Right ("string1", "\"")
      runParser parseString "\"string1\t\"" @?= Right ("string1\t", "")
      runParser parseString "\"string1\"\t" @?= Right ("string1", "\t")
      runParser parseString "\"string1\n\"" @?= Right ("string1\n", "")
      runParser parseString "\"string1\"\n" @?= Right ("string1", "\n")
      runParser parseString "\"string1\r\"" @?= Right ("string1\r", "")
      runParser parseString "\"string1\"\r" @?= Right ("string1", "\r")
      runParser parseString "\"string1\"\\\"" @?= Right ("string1", "\\\"")
      runParser parseString "\"string1\"\\\\" @?= Right ("string1", "\\\\")
      runParser parseString "\"string1\"\\0" @?= Right ("string1", "\\0")
